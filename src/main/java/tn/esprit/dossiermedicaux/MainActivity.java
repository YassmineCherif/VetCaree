package tn.esprit.dossiermedicaux;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        btnAddDossier.setOnClickListener(new View.OnClickListener(){
            ...
            public void onClick(View v) {
                ...
                startActivityForResult(new Intent(MainActivity.this, AddDossierActivity.class), 1);
            }
        });
        ...
        lvDossiers.setOnItemClickListener(new AdapterView.OnItemClickListener() {
            ...
            public void onItemClick(AdapterView<?> parent, View view, int position, long id) {
                ...
                Intent intent = new Intent(MainActivity.this, EditDossierActivity.class);
